  ...
  {"Humanoid"=>
   ...
   "Celestial"=>
    [:couatl,
     ...
     :unicorn]},
 :groups=>
  {:bugbear=>{:troops=>[:bugbear], :bosses=>[:bugbear_chief]},
   :undead=>
    {:troops=>[:ghast, :ghoul, :shadow, :skeleton, :specter, :zombie],
     :bosses=>[]},
   :undead_mythical=>
    {:troops=>[:ghoul, :minotaur_skeleton, :mummy, :skeleton, :zombie],
     :bosses=>[:mummy_lord]},
   :undead_vampire=>
    {:troops=>
      [:ghoul,
       ...
       :zombie],
     :bosses=>[]},
   :goblin=>{:troops=>[:goblin], :bosses=>[:goblin_boss]},
   :hobgoblin=>
    {:troops=>[:hobgoblin], :bosses=>[:hobgoblin_captain, :hobgoblin_warlord]},
   :orc=>{:troops=>[:orc], :bosses=>[:orc_eye_of_gruumsh, :orc_war_chief]}}}
end
